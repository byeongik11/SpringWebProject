...
//게시글 보기
function setContentNo(textNum) {
	document.getElementById("textNo").value = textNum;
	viewContent();
}

function viewContent() {
	document.getElementById("viewContent").submit();
}	

function setSearchText(index, pageCnt) {
	alert("검색");
	document.getElementById("searchWhat").value = document.getElementById("searchType").value;
	document.getElementById("searchTxt").value = document.getElementById("searchText").value;
	
	pagePre(index, pageCnt);
}