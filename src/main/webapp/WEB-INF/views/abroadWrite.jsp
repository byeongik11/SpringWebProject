...
<body>
	...
	<div class="wrapper">
		<div id="abroadpage" class="container">
			...
			<form class="form-abroadWrite" method="post"	action="abroadInsert.do">
					...
					<table class="table table-bordered">
					    <tbody>
					            ...
					            <tr>
					            	...
					            	<td class="tabletd"><input type="text" name="trvAreaDtail" id="inputLocDtl" class="inputData" placeholder="여행지(국가명)를 입력해주세요." required autofocus></td>
					            </tr>
					            <tr>
					            	<th class="tableth">여행경비</th>
					            	<td class="tabletd"><input type="text" name="cost" id="inputMoney" class="inputData" placeholder="여행 경비를 입력해주세요." required autofocus>  (단위 : 원)</td>
					            </tr>
					            <tr>
