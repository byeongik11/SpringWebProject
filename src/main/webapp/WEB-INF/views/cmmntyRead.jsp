...
function re_comment(CMTNO) {
	...
	/* alert(data); */
		...
		var html  = "<form id='commentForm' name='commentForm' method='post'>";
			...
			html += "<a onclick='fn2_comment("+${CMMNTYDTO.bod_no}+")' class='button'>등록</a>";
	 		html += "</div>";
	 		html += "</div>";
	 		html += "</form>";
	...
	<div class="alines">
		<div id="abwrap" class="wrapper">
			<div class="titleWrite">
				<h2>
					<span style="color: skyblue;">Community Board ෆ</span>
				</h2>
			</div>
			...
			<div class="readForm">
				<c:if test="${CMMNTYDTO != null }">
					<div class="row1">
						...
						<div class="middle1">${CMMNTYDTO.bod_title}
							<table style="float: right;">
								<tr>
									<td>조회수</td>
									<td>${CMMNTYDTO.bod_cnt}</td>
								</tr>
							</table>
						</div>
					</div>
				...
				<div class="comment">
					...
					<form id="commentForm" name="commentForm" method="post">
						<div class="cmtbody2">
							...
							<div class="rightc6">
								<a onclick="fn_comment('${CMMNTYDTO.bod_no}')" id="reIst" class="button">등록</a>
							</div>
						</div>
						<input type="hidden" id="b_code" name="bod_no" value="${CMMNTYDTO.bod_no}">
					</form>
