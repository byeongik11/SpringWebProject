						...
						<table class="table table-bordered">
							...
							<tbody>
								<tr>
									...
									<td class="tabletd"><input type="text" id="inputTitle" name="bod_title" value="${CMMNTYDTO.bod_title}" required="required" /></td>
									<td></td>
								</tr>
								<tr>
									<th class="tableth">내용</th>
									<td class="tabletd"><textarea cols="10" placeholder="내용을 입력하세요. " name="bod_text" id="comm_content" class="taContent" required autofocus>${CMMNTYDTO.bod_text}</textarea></td>
							</tbody>
