...
<body>
	...
	<div class="wrapper">
		<div id="loginpage" class="container">
			<div class="title">
				<h2><span style="color: skyblue;">Find  Userid/Password</span></h2>
				...
				<div id="loginform">
					<form name="findId" action="findId.do" method="post">
						...
						<div id="loginTop">
							Find  Userid<br>
							<input type="text" id="userid" name="mem_name" placeholder="이름을 입력해 주세요." required="required"><br>
							<input type="text" id="birth" name="mem_birth" placeholder="생년월일 6자리를 입력해 주세요" required="required"><br>
							<input type="text" id="tel" name="mem_tel" placeholder="휴대전화 11자리를 입력해 주세요" required="required">
						</div>
						...
						<p id="result">
							...
							<c:if test="${ID != null}">
								<span style="color: blue; font-size: 14px;">${NAME}님의 ID는 ${ID}입니다.</span>
							</c:if>
						</p>
				...
				<div id="loginform">
					<form name="findPw" action="findPw.do" method="post">
					
						<div id="loginTop">
							Find  Password<br>
							<input type="text" id="userid" name="mem_id" placeholder="아이디를 입력해 주세요." required="required"><br>
							<input type="text" id="birth" name="mem_birth" placeholder="생년월일 6자리를 입력해 주세요" required="required"><br>
							<input type="text" id="tel" name="mem_tel" placeholder="휴대전화 11자리를 입력해 주세요" required="required">
						</div>
						...
						<p id="result">
							...
							<c:if test="${PW != null}">
								<span style="color: blue; font-size: 14px;">${NAME}님의 Password는 ${PW}입니다.</span>
							</c:if>
						</p>
