...
<body>
	...
	<div class="wrapper">
		<div id="domesticpage" class="container">
			...
			<form class="form-domesticWrite" method="post"	action="guideUpdate.do">
				...
				<div id="writeForm">
					<table class="table table-bordered">
					    <tbody>
					            ...
					            <tr>
					                ...
					                <td class="tabletd"><input type="date" name="startDate" id="inputSDate" value="${SDATE}" onChange="inputDateComparison(this);" required autofocus> ~ 
					                <input type="date" name="endDate" id="inputEDate" value="${EDATE}" onChange="inputDateComparison(this);" required autofocus></td>
					            </tr>
					            <tr>
					...
					<c:if test="${MEM_NUM == boardDto.mbrCode}">
						...
						<input type="button" id="backward" value="이전" onclick="document.location.href='domesticContent.do?value=${boardDto.textNo}'">
					</c:if>
					</div>
