...
<body>
	...
	<div class="wrapper">
		<div id="mbrjoin" class="container">
			<div class="title">
				<h2><span style="color: skyblue;">ෆ Join to Gayage ෆ</span></h2>
				
				<div id="joinform">
					<form name="join" action="joinInsert.do" method="post">
						<table id="jointable">
							<tr>
								<td class="jointitle" style="padding-bottom: 0em;">* 아이디</td>
								<td class="join" style="padding-bottom: 0em;"><input type="text" class="mbrjoin" name="mem_id" placeholder="영문,숫자 포함 15자 이하 입력" required="required" size="50" style="height: 30px;"></td>						
								<td class="join" style="padding-bottom: 0em;"><input type="button" id="chkid" value="중복조회" /></td>
							</tr>
							<tr style="height: 2em;">
							...
							<tr>
								...
								<td class="join"><input type="password" class="mbrjoin" name="mem_pw" placeholder="영문,숫자,특수문자 포함 6자 이상 입력" required="required" size="50" style="height: 30px;"></td>						
							</tr>
							<tr>
								<td class="jointitle">* 비밀번호 확인</td>
								<td class="join"><input type="password" class="mbrjoin" name="mem_pw2" placeholder="영문,숫자,특수문자 포함 6자 이상 입력" required="required" size="50" style="height: 30px;">
						...
						<div id="lower" align="center">
							<input type="submit" id="mbrjoinBtn" value="회원가입" />
						</div>
					</form>
				</div>				
