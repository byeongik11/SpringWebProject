...
<body>
	...
	<div class="wrapper">
		<div id="grouppage" class="container">
			...
			<form class="form-groupWrite" method="post"	action="/WebProjectV201/groupInsert.do">
					...
					<table class="table table-bordered">
					    <tbody>
					            <tr>
					                ...
					                <td class="tabletd"><input type="text" name="title" id="inputTitle" class="inputData" placeholder="제목을 입력해주세요" required autofocus></td>
					            </tr>
					            <tr>
					                <th class="tableth">여행 기간</th>
					                <td class="tabletd"><input type="date" name="startDate" id="inputSDate" onChange="inputDateComparison(this);" required autofocus> ~ 
					            ...
					            <tr>
					            	...
					            	<td class="tabletd"><input type="text" name="trvAreaDtail" id="inputLocDtl" class="inputData" placeholder="상세지역 입력" required autofocus></td>
					            </tr>
					            <tr>
					            	<th class="tableth">여행경비</th>
					            	<td class="tabletd"><input type="text" name="cost" id="inputMoney" class="inputData" placeholder="여행 경비 입력" required autofocus>(단위 : 원)</td>
					            </tr>
					            <tr>
					                <th class="tableth">최대 인원</th>
					                <td class="tabletd"><input type="text"  name="max" id="inputMax" class="inputData" placeholder="최대인원 입력 "  required autofocus>명</td>
					            </tr>
					            <tr>
					                <th class="tableth">이동 수단</th>
					                <td class="tabletd"><textarea cols="10" rows="2" name="trans" id="inputTrans" class="taContent" placeholder="내용을 입력하세요. "  required autofocus></textarea></td>
					            </tr>
					            <tr>
					            	<th class="tableth">여행 일정</th>
					            	<td class="tabletd"><textarea cols="10" rows="5" name="content" id="inputTip" class="taContent" placeholder="내용을 입력하세요. " required autofocus></textarea></td>
					            </tr>
					            <tr>
					                <th class="tableth">기타사항</th>
					                <td class="tabletd"><textarea cols="10" rows="5" name="etc" id="inputEtc" class="taContent" placeholder="내용을 입력하세요. "  required autofocus></textarea></td>
					            </tr>
					    </tbody>
					</table>
					<div id="lowerBtn">
						<button class="backPage"   type="button" onclick="document.location.href='/WebProjectV201/abroadBoard.do'">목록보기</button>
